...
add_action( 'after_setup_theme', 'inhabitent_width', 0 );
...
function inhabitent_scripts() {
  ...
  // to queue custom.js
  wp_enqueue_script( 'inhabitent-custom-js', get_template_directory_uri() . '/build/js/custom.min.js', array('jquery'), '20181109', true );
